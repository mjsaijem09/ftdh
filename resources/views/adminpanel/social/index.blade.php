    ...
    <div class="container-fluid">
      <div class="row">
        ...
        <div class="card col-lg-4" style="height: 100%">
          <form class="card-body" method="POST" action="{{ route('socials.store') }}">
            ...
            <div class="form-group">
              <button class="btn btn-success btn-block">Add Social</button>
            </div>
                 ...
                 <tbody>
                    ...
                    <tr>
                      ...
                      <td style="float: right;">
                        <form action="{{ route('categories.destroy',$social->id) }}" method="POST">
   
                          <a class="btn btn-primary" href="{{ route('socials.edit',$social->id) }}">Edit</i></a>
         
                          @csrf
                          @method('DELETE')
            
                          <button type="submit" class="btn btn-danger">Drop</i></button>
                      </form>
                      </td>
                    </tr>
                    @endforeach
