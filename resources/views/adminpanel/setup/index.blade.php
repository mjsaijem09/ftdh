      ...
      <div class="container-fluid">
        <div class="row">
          ...
          <div class="card col-md-6">
            <form class="card-body" action="{{ route('setups.edit',$data->id) }}">
            {{ csrf_field() }}
            <input type="hidden" name="tbl" value="{{encrypt('setups')}}">

              <div class="col-sm-3">
                <div class="form-group" style="padding: 30px 0 30px">
                  <input type="file" accept="image/*" name="image" value="{{ $data -> image }}" id="file" onchange="loadFile(event)" style="display: none" disabled>
                ...
                <div class="row">
                  <div class="col-md-12">
                    <div class="form-group">
                      ...
                      <input type="text" name="meta_title" value="{{$data->meta_title}}" class="form-control" disabled>
                    </div>
                  </div>
                  <div class="col-md-6">
                    <div class="form-group">
                      <label class="bmd-label-floating">Address</label>
                      <input type="text" name="address" value="{{$data->address}}" class="form-control" disabled>
                    </div>
                  </div>
                  <div class="col-md-6">
                    <div class="form-group">
                      <label class="bmd-label-floating">Contant number</label>
                      <input type="text" name="contact" value="{{$data->contact}}" class="form-control" disabled>
                    </div>
                  </div>
                </div>
                <div class="row">
                  <div class="col-md-12">
                    <div class="form-group">
                      ...
                      <input type="email" name="email" value="{{$data->email}}" class="form-control" disabled>
                    </div>
                  </div>
                  </div>
                  <div class="row">
